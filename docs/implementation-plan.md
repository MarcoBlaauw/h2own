...
### Partial/Placeholder
- Dashboard metrics are currently static.
- Recommendations UI is static and not yet wired to preview results.
...
### 2) Complete recommendation workflow
- Add endpoint to persist recommendations.
- Add endpoint to update recommendation status and feedback.
- Extend the web UI to apply/track recommendations.

### 3) Dosing and history
